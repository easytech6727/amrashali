    ...
    <footer className="bg-primary text-white mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-serif font-bold mb-4">AB Journal</h3>
            <p className="text-sm text-gray-300">
              Community-driven journal publishing investigative reporting,
              first-person accounts, and research that highlights human rights issues.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/owner" className="text-gray-300 hover:text-white transition-colors">
                  About the Author
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-primary-light mt-8 pt-8 text-center text-sm text-gray-300">
          <p>&copy; {currentYear} AB Journal. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
